...
public class Restaurant {
	...
	public Restaurant()
	{
		frame=new JFrame("Welcome to Foods For All");
		
		frame.setContentPane(new JLabel(new ImageIcon("C:\\Users\\Welcome\\Pictures\\Saved Pictures")));
		/*ImageIcon img=new ImageIcon("tree.png");
		img.setDescription("This is logo");
		JLabel l=new JLabel(img);
		l.setBounds(100,20,300,100);*/
		
		heading=new JLabel("Food For All");
